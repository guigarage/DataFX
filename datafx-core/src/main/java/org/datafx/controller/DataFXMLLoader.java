...
public class DataFXMLLoader {
            ...
            if (aValue.startsWith(ESCAPE_PREFIX)) {
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    if (aValue.charAt(0) == '/') {
                        ...
                        try {
                            return new URL(DataFXMLLoader.this.location, aValue).toString();
                        } catch (MalformedURLException e) {
                            System.err.println(DataFXMLLoader.this.location + "/" + aValue);
                        }
                    }
                }
    ...
    protected void bindValueElement(String fx_id, Object value, Map<String, Object> properties) {
        ...
        if(parentLoader != null) {
            parentLoader.bindValueElement(fx_id, value, properties);
        }
    ...
    private abstract class ValueElement extends Element {
        ...
        private void processValue() throws LoadException {
            ...
            if (fx_id != null) {
                ...
                bindValueElement(fx_id, value, getProperties());
    ...
    private class IncludeElement extends ValueElement {
        ...
        public ResourceBundle resources = DataFXMLLoader.this.resources;
        public Charset charset = DataFXMLLoader.this.charset;
            ...
            if (prefix == null) {
                if (localName.equals(INCLUDE_SOURCE_ATTRIBUTE)) {
                    ...
                    resources = ResourceBundle.getBundle(value, Locale.getDefault(),
                            DataFXMLLoader.this.resources.getClass().getClassLoader());
        ...
        public Object constructValue() throws IOException {
            ...
            if (source.charAt(0) == '/') {
                ...
                if (DataFXMLLoader.this.location == null) {
                    throw constructLoadException("Base location is undefined.");
                }

                location = new URL(DataFXMLLoader.this.location, source);
            }

            DataFXMLLoader fxmlLoader = new DataFXMLLoader(location, resources,
                    builderFactory, controllerFactory, charset,
                    loaders);
            fxmlLoader.parentLoader = DataFXMLLoader.this;

            if (isCyclic(DataFXMLLoader.this, fxmlLoader)) {
                throw new IOException(
                        String.format(
                                "Including \"%s\" in \"%s\" created cyclic reference.",
                                fxmlLoader.location.toExternalForm(),
                                DataFXMLLoader.this.location.toExternalForm()));
            }
            ...
            if (fx_id != null) {
                ...
                if (DataFXMLLoader.this.controller != null) {
                    Field field = controllerAccessor.getControllerFields()
                            .get(id);

                    if (field != null) {
                        try {
                            field.set(DataFXMLLoader.this.controller, controller);
                        } catch (IllegalAccessException exception) {
                            throw constructLoadException(exception);
                        }
                    }
    ...
    private final LinkedList<DataFXMLLoader> loaders;

    private ClassLoader classLoader = null;
    private boolean staticLoad = false;
    private LoadListener loadListener = null;

    private DataFXMLLoader parentLoader;
    ...
    /**
     * Creates a new DataFXMLLoader instance.
     */
    public DataFXMLLoader() {
        this((URL)null);
    }
     ...
     * @since JavaFX 2.1
     */
    public DataFXMLLoader(URL location) {
        this(location, null);
    }
     ...
     * @since JavaFX 2.1
     */
    public DataFXMLLoader(URL location, ResourceBundle resources) {
     ...
     * @since JavaFX 2.1
     */
    public DataFXMLLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory) {
     ...
     * @param charset
     */
    public DataFXMLLoader(Charset charset) {
    ...
    public DataFXMLLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory,
                      Callback<Class<?>, Object> controllerFactory, Charset charset,
                      LinkedList<DataFXMLLoader> loaders) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DataFXMLLoader) {
            DataFXMLLoader loader = (DataFXMLLoader)obj;
    ...
    private String constructFXMLTrace() {
        ...
        for (DataFXMLLoader loader : loaders) {
        ...
        if (defaultClassLoader == null) {
            ...
            if (sm != null) {
                final ClassLoader callerClassLoader = (caller != null) ?
                        ...
                        null;
                if (needsClassLoaderPermissionCheck(callerClassLoader, DataFXMLLoader.class.getClassLoader())) {
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        DataFXMLLoader.defaultClassLoader = defaultClassLoader;
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
        ...
        DataFXMLLoader fxmlLoader =
                new DataFXMLLoader(location, resources, builderFactory,
